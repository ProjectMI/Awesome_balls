...
{
    public NANDRequirement(final Requirement left, final Requirement right) {
        super(left, right);
    }
    ...
    protected String getFormat() {
        return new TextComponentTranslation("reskillable.requirements.format.nand", new Object[0]).getUnformattedComponentText();
    }
