...
{
    public XNORRequirement(final Requirement left, final Requirement right) {
        super(left, right);
    }
    ...
    protected String getFormat() {
        return new TextComponentTranslation("reskillable.requirements.format.xnor", new Object[0]).getUnformattedComponentText();
    }
