...
public class Baubles {
    ...
    private void setupClient(FMLClientSetupEvent event) {
        MenuScreens.m_96206_((MenuType)ModMenus.PLAYER_BAUBLES.get(), PlayerExpandedScreen::new);
        KEY_BAUBLES = new KeyMapping("keybind.baublesinventory", 66, "key.categories.inventory");
