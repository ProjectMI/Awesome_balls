...
public class ClientUtils {
	public static void drawNonStandardTexturedRect(int x, int y, int u, int v, int width, int height, int textureWidth, int textureHeight)
    {
        ...
        bb.pos(x, y + height, 0).tex(u * f, (v + height) * f1).endVertex();
        bb.pos(x + width, y + height, 0).tex((u + width) * f, (v + height) * f1).endVertex();
        bb.pos(x + width, y, 0).tex((u + width) * f, v * f1).endVertex();
        bb.pos(x, y, 0).tex(u * f, v * f1).endVertex();
        tessellator.draw();
    }
	...
	public static void drawRect(int x, int y, int width, int height)
    {
        ...
        bb.pos(x, y + height, 0).endVertex();
        bb.pos(x + width, y + height, 0).endVertex();
        bb.pos(x + width, y, 0).endVertex();
        bb.pos(x, y, 0).endVertex();
        tessellator.draw();
    }
	
	public static void drawScaledText(FontRenderer render, String text, int x, int y, int color, float scaleFactor) {
		GL11.glPushMatrix();
