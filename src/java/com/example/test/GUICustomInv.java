...
public class GUICustomInv extends GuiContainer{
	...
	/*Путь к текстуре - MOD_ID + :textures/gui/inventory_gui.png.
    ...
    MOD_ID - идентификатор мода. То, что указано в аннотации @Mod(modid="MOD_ID"). У меня это значение хранится в переменной в главном классе TestMod,
